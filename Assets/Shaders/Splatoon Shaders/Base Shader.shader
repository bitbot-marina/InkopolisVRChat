...
Shader "Shader Forge/Base Shader" {
    Properties {
        ...
        [MaterialToggle] _DoyouhaveaMTL ("Do you have a MTL?", Float ) = 0
        ...
        [MaterialToggle] _IsitaCutOut ("Is it a Cut Out?", Float ) = 1
        _RGH ("RGH", 2D) = "white" {}
        ...
        _NoMTLSlider ("No MTL Slider", Range(0, 1)) = 0
        ...
        _CUTOUTOverride ("CUT OUT Override", Range(0, 2)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform fixed _IsitaCutOut;
            uniform float _CUTOUTOverride;
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                clip((lerp( 1.0, _MainTex_var.a, _IsitaCutOut )*_CUTOUTOverride) - 0.5);
...
////// Specular:
                ...
                float3 _DoyouhaveanALB_var = lerp( _ColorOverride.rgb, (_ColorOverride.rgb*_MainTex_var.rgb), _DoyouhaveanALB );
